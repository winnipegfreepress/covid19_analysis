...
p_new_daily_cases_avg <- plot_bar_timeseries_w_avg(
  wfp_daily_totals,
  x_var=date,
  ...
  ymin=0, ymax=1500, y_units="",
  source_str="Manitoba Health", lastupdate_str=last_update_timestamp
)

p_new_daily_cases_avg <- p_new_daily_cases_avg +
...
wfp_new_daily_cases_avg <- prepare_plot(p_new_daily_cases_avg)

ggsave_pngpdf(wfp_new_daily_cases_avg, "wfp_new_daily_cases_avg", width_var=8.66, height_var=6, dpi_var=300, scale_var=1, units_var="in")
ggsave_pngpdf(wfp_new_daily_cases_avg, "wfp_daily_cases_7daymav", width_var=8.66, height_var=6, dpi_var=300, scale_var=1, units_var="in")

ggsave_pngpdf(wfp_new_daily_cases_avg, "wfp_new_daily_cases_avg_sq", width_var=8.66, height_var=8.66, dpi_var=300, scale_var=1, units_var="in")
